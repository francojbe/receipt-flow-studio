        ...
        {movements.length === 0 ? (
          ...
          movements.map((mov, index) => {
            ...
            return (
              <div
                key={index}
                className="px-6 py-4 flex justify-between items-center hover:bg-secondary/50 transition-colors group"
              >
                <div className="flex items-center gap-3 w-2/3">
                  <div
                    className={`w-10 h-10 flex-shrink-0 rounded-full ${iconConfig.bgColor} ${iconConfig.textColor} flex items-center justify-center`}
                  >
                    {iconConfig.icon}
                  </div>
